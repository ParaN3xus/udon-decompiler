...
pub struct DecompileContext {
    ...
    pub inferred_output_stem: String,
    pub bytecode: Vec<u8>,
...
impl DecompileContext {
    ...
    pub const CLASS_NAME_SYMBOL_NAME: &'static str = "__refl_typename";
    ...
    pub fn from_program(program: &UdonProgramBinary) -> Result<Self> {
        ...
        let mut ctx = Self {
            ...
            inferred_output_stem: "Decompiled_Program".to_string(),
            bytecode,
            instructions,
            heap_capacity,
    ...
    pub fn inferred_program_class_name(&self) -> Option<String> {
        ...
        if symbol.name != Self::CLASS_NAME_SYMBOL_NAME {
            return None;
        }
    ...
    pub fn infer_output_stem_for_file(&self) -> String {
        self.inferred_output_stem.clone()
    }
    ...
    fn refresh_inferred_class_name(&mut self) {
        ...
        self.inferred_output_stem = sanitize_output_stem(inferred_raw);
    }
}
...
fn load_heap_data(program: &UdonProgramBinary) -> Result<LoadedHeapData> {
    ...
    for i in 0..len {
        ...
        out.push(DecompileHeapEntry {
            ...
            type_name,
            init_value,
            is_init_serializable: !matches!(literal, HeapLiteralValue::Unserializable),
        });
    }
    Ok(LoadedHeapData {
        entries: out,
